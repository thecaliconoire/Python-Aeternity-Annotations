...
class EpochClient:
    ...
    def get_pubkey(self):
        pub_key = self.internal_http_get('account/pub-key') #self does not "internal_http_get" member 
    ...
    def get_height(self):
        top = self.cli.get_top() #OPENAPI No get top member
...
#TODO: Why is self. in line 211 to 329 have no members in the API methods??? 
